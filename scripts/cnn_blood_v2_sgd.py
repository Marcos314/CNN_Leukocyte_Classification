...
def buildModel():
    ...
    # Compilação
    model.compile(optimizer = keras.optimizers.SGD(lr=0.01, nesterov=True) , loss = 'sparse_categorical_crossentropy' , metrics = ['accuracy'])
    
    # Callback
    checkpoint = ModelCheckpoint(filepath='blood_model_check_point.hdf5', save_best_only=True, save_weights_only=False)
    ...
    model.save('BloodModel_20210727_epochs50_sgd.h5')
...
# # Salvar o modelo
# model.save('BloodModel_20210727_epochs20_newdataset.h5')
