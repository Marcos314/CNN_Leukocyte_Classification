...
Original file is located at
    https://colab.research.google.com/drive/1ESBcUvzI6UOGQoC-GNviwTMSKEj_UMct
...
train1 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/train/eosinofilo')
# Diretorio com imagens de validação de eosinofilo 
valid1 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/valid/eosinofilo')

# Diretorio com imagens de treino de linfocito
train2 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/train/linfocito')
# Diretorio com imagens de validação de linfocito 
valid2 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/valid/linfocito')

# Diretorio com imagens de treino de monocito
train3 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/train/monocito')
# Diretorio com imagens de validação de monocito 
valid3 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/valid/monocito')

# Diretorio com imagens de treino de neutrofilo
train4 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/train/neutrofilo')
# Diretorio com imagens de validação de neutrofilo 
valid4 = os.path.join('/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/valid/neutrofilo')
...
def loadDataset():
    datasets = ['/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/train/','/home/marcos/TCC_2020/dataset/novo/blood_input_as_zip/valid/']
    images = []
    labels = []
    image_size = (150,150)
